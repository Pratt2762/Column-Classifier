...
OPS = {
    ...
    'avg_pool_2': lambda C, stride, affine: PoolBN('avg', C, 3, stride, 'same', affine=affine),
    'max_pool_2': lambda C, stride, affine: PoolBN('max', C, 3, stride, 'same', affine=affine),
    'skip_connect': lambda C, stride, affine: \
        Identity() if stride == 1 else FactorizedReduce(C, C, affine=affine),
    'sep_conv_2': lambda C, stride, affine: SepConv(C, C, 2, stride, 'same', affine=affine),
    'sep_conv_3': lambda C, stride, affine: SepConv(C, C, 3, stride, 'same', affine=affine),
    'sep_conv_4': lambda C, stride, affine: SepConv(C, C, 4, stride, 'same', affine=affine),
    'conv_3x1_1x3': lambda C, stride, affine: FacConv(C, C, 3, stride, 'same', affine=affine)
}
