...
def from_str(s):
    ...
    e.g. "Genotype(
            normal=[[('sep_conv_3', 0), ('sep_conv_3', 1)],
                    [('sep_conv_3', 1), ('dil_conv_3', 2)],
                    [('sep_conv_3', 1), ('sep_conv_3', 2)],
                    [('sep_conv_3', 1), ('dil_conv_3', 4)]],
            normal_concat=range(2, 6),
            reduce=[[('max_pool_2', 0), ('max_pool_2', 1)],
                    [('max_pool_2', 0), ('skip_connect', 2)],
                    [('max_pool_2', 0), ('skip_connect', 2)],
                    [('max_pool_2', 0), ('skip_connect', 2)]],
